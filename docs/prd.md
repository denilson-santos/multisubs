...
model in retained metadata. Parakeet and Qwen3-ASR temporary WAV input is
removed after success or failure; missing native or forced-alignment timestamps
produce coarse static cues instead of invented word timing.
