...
7. A user can change an exposed semantic appearance option or choose a named position and see it reflected in the generated ASS style definition and rendered video without providing raw ASS field names, ASS alignment codes, or ASS color syntax.
