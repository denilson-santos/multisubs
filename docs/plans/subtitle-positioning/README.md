...
| 7 | [Placement modes and maximum height](07-placement-modes-and-maximum-height.md) | In review | 0–6 | [#35](https://github.com/denilson-santos/multisubs/pull/35) |
...
is under review in pull request #35 from `feat/subtitle-placement-envelopes`.
