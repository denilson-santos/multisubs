...
| --- | --- | ---: | --- | --- |
| Subtitle positioning | Done | 10/10 | Complete | [Open dashboard](subtitle-positioning/README.md) |
...
| Subtitle templates | In review | 4/6 | Plan 4 — Curated social templates (ready for review); next: Plan 5 — Custom template files (Planned) | [Open dashboard](subtitle-templates/README.md) |
